...
4. K Unplugged CT ✅ **SHIPPED (8)** → 5. K Sequencing & Algorithms ✅ **SHIPPED (8)** → 6. K Intro Block Coding ✅ **SHIPPED (8)** → 7. G1 Block Coding (Sequential) ✅ **SHIPPED (8)** → 8. G1 Unplugged Sequencing ✅ **SHIPPED (8)** → **9. G1 Intro Debugging ← NEXT** → 10–12. Grade 2 (3).  *(8/12 subjects, 61 sheets shipped. K COMPLETE; G1 2/3.)*
