...
4. K Unplugged CT ✅ **SHIPPED (8)** → 5. K Sequencing & Algorithms ✅ **SHIPPED (8)** → 6. K Intro Block Coding ✅ **SHIPPED (8)** → 7. G1 Block Coding (Sequential) ✅ **SHIPPED (8)** → 8. G1 Unplugged Sequencing ✅ **SHIPPED (8)** → 9. G1 Intro Debugging ✅ **SHIPPED (8)** → **10. G2 Block Coding (Concurrent) ← NEXT** → 11–12. Grade 2 (2 more).  *(9/12 subjects, 69 sheets shipped. K + G1 COMPLETE.)*
